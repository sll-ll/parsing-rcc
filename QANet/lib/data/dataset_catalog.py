...
COMMON_DATASETS = {
    ...
    'CIHP_body_train': {
        _IM_DIR:
            _DATA_DIR + '/CIHP_body/Training/Images',
        _ANN_FN:
            _DATA_DIR + '/CIHP_body/annotations/CIHP_train.json',
        _FIELDS:
    ...
    'CIHP_body_val': {
        _IM_DIR:
            _DATA_DIR + '/CIHP_body/Validation/Images',
        _ANN_FN:
            _DATA_DIR + '/CIHP_body/annotations/CIHP_val.json',
        _FIELDS:
            {'flip_map': ([14, 15], [16, 17], [18, 19]),
             'ignore_label': 255,
    ...
    'CIHP_body_test': {
        _IM_DIR:
            _DATA_DIR + '/CIHP_body/Testing/Images',
        _ANN_FN:
            _DATA_DIR + '/CIHP_body/annotations/CIHP_test.json',
        _FIELDS:
            {'flip_map': ([14, 15], [16, 17], [18, 19]),
             'ignore_label': 255,
